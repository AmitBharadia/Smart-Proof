...
public abstract class Contract extends ManagedTransaction {
    ...
    private static <T extends org.web3j.tx.Contract> T create(
    ...
    protected static <T extends org.web3j.tx.Contract> T deploy(
            Class<T> type,
            Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit,
    ...
    protected static <T extends org.web3j.tx.Contract> RemoteCall<T> deployRemoteCall(
            Class<T> type,
            Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit,
            String binary, String encodedConstructor, BigInteger value) {
